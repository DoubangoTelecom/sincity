...
public:
	virtual ~SCUrl();
	virtual SC_INLINE const char* getObjectId() { return "SCUrl"; }

	virtual SC_INLINE SCUrlType_t getType()const { return m_eType; }
	virtual SC_INLINE SCUrlHostType_t getHostType()const { return m_eHostType; }
	virtual SC_INLINE std::string getScheme()const { return m_strScheme; }
	virtual SC_INLINE std::string getHost()const { return m_strHost; }
	virtual SC_INLINE std::string getHPath()const { return m_strHPath; }
	virtual SC_INLINE std::string getSearch()const { return m_strSearch; }
	virtual SC_INLINE unsigned short getPort()const { return m_nPort; }
