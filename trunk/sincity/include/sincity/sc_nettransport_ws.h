...
public:
	...
	virtual ~SCWsResult();
	virtual SC_INLINE const char* getObjectId() { return "SCWsResult"; }

	virtual SC_INLINE unsigned short getCode() { return m_nCode; }
	virtual SC_INLINE const char* getPhrase() { return m_pPhrase; }
	virtual SC_INLINE const void* getDataPtr() { return m_pDataPtr; }
	virtual SC_INLINE size_t getDataSize() { return m_nDataSize; }
	virtual SC_INLINE SCWsActionType_t getActionType() { return m_eActionType; }
...
public:
	...
	virtual SC_INLINE const char* getObjectId() { return "SCWsTransportCallback"; }
...
public:
	...
	virtual SC_INLINE const char* getObjectId() { return "SCWsTransport"; }
