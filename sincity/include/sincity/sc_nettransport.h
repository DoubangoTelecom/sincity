...
public:
	...
	virtual const char* getWsKey() { return m_pWsKey; }
	virtual SC_INLINE bool isStream() = 0;

protected:
	virtual SC_INLINE void setConnected(bool bConnected) { m_bConnected = bConnected; }
...
public:
	...
	virtual SC_INLINE const char* getObjectId() { return "SCNetPeerDgram"; }
	virtual SC_INLINE bool isStream(){ return false; }
};
...
public:
	...
	virtual SC_INLINE SCNetTransporType_t getType() { return m_eType; }
	virtual SC_INLINE bool isStarted(){ return m_bStarted; }
	virtual SC_INLINE bool isValid(){ return m_bValid; }
	virtual SC_INLINE void setCallback(SCObjWrapper<SCNetTransportCallback*> oCallback) { m_oCallback = oCallback; }
