...
SCObjWrapper<SCUrl*> sc_url_parse(const char *urlstring, tsk_size_t length)
{
    ...
    /* #line 88 "./ragel/sc_parser_url.rl" */
    (void)(ts);
    (void)(te);
    (void)(act);
    (void)(eof);
    ...
    /* #line 299 "./src/sc_parser_url.cc" */
    {
        cs = sc_machine_parser_url_start;
    }

    /* #line 96 "./ragel/sc_parser_url.rl" */

    /* #line 306 "./src/sc_parser_url.cc" */
    {
        int _klen;
        unsigned int _trans;
        const char *_acts;
...
_match:
        ...
        while ( _nacts-- > 0 ) {
            ...
            {
                scheme = tsk_strdup("tcp"), eType = SCUrlType_TCP;
            }
            break;
            case 2:
                /* #line 21 "./ragel/sc_parser_url.rl" */
            {
                scheme = tsk_strdup("tls"), eType = SCUrlType_TLS;
            }
            break;
            case 3:
                /* #line 22 "./ragel/sc_parser_url.rl" */
            {
                scheme = tsk_strdup("http"), eType = SCUrlType_HTTP;
            }
            break;
            case 4:
                /* #line 23 "./ragel/sc_parser_url.rl" */
            {
                scheme = tsk_strdup("https"), eType = SCUrlType_HTTPS;
            }
            break;
            case 5:
                /* #line 24 "./ragel/sc_parser_url.rl" */
            {
                scheme = tsk_strdup("ws"), eType = SCUrlType_WS;
            }
            break;
            case 6:
                /* #line 25 "./ragel/sc_parser_url.rl" */
            {
                scheme = tsk_strdup("wss"), eType = SCUrlType_WSS;
            }
            break;
            case 7:
                /* #line 28 "./ragel/sc_parser_url.rl" */
            {
                eHostType = SCUrlHostType_IPv4;
            }
            break;
            case 8:
                /* #line 29 "./ragel/sc_parser_url.rl" */
            {
                eHostType = SCUrlHostType_IPv6;
            }
            break;
            case 9:
                /* #line 30 "./ragel/sc_parser_url.rl" */
            {
                eHostType = SCUrlHostType_Hostname;
            }
            break;
            case 10:
